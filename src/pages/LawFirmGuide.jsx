  ...
  <main className="bg-[#050e19] text-white">
    <section className="relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 pt-28 sm:pt-32">
        <div className="rounded-3xl border border-white/10 bg-[#0A1A2F]/85 p-6 sm:p-8 backdrop-blur">
          <p className="text-sm uppercase tracking-[0.3em] text-[#C6FF4D] font-semibold">Law Firm Guide</p>
          <h1 className="mt-4 text-3xl sm:text-4xl font-bold">Bring NoPo to Your Firm in the Way That Fits You</h1>
          <p className="mt-4 text-base text-white/80 max-w-3xl">
            NoPo is the AI-powered ticket intake and strategy platform. Start with a simple upgrade, move into the
            full platform, or go white-label. Flagship partners also earn referral revenue when they introduce NoPo to
            other firms.
          </p>
        </div>
      </div>
    ...
    <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10">
      <div className="grid gap-6 md:grid-cols-2">
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <h2 className="mt-3 text-xl font-semibold">A case-ready intake system.</h2>
          <ul className="mt-4 space-y-3 text-white/70 text-base">
            <li>Ticket intake captures key details fast.</li>
            <li>Guided steps help clients finish the form.</li>
            <li>Attorney dashboard tracks status and documents.</li>
            <li>Optional voice assistant increases completions.</li>
          </ul>
        </div>

        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          <p className="text-sm uppercase tracking-[0.2em] text-white/50">Why it matters</p>
          <h2 className="mt-3 text-xl font-semibold">More signed cases, less admin work.</h2>
          <ul className="mt-4 space-y-3 text-white/70 text-base">
            <li>Faster intake means more completed leads.</li>
            <li>Cleaner files reduce paralegal back-and-forth.</li>
            <li>Clear next steps increase conversion.</li>
            <li>Same process across teams and locations.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
      <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
        ...
        <h2 className="mt-3 text-xl font-semibold">Choose the level that matches your goals.</h2>
        <p className="mt-2 text-base text-white/70 max-w-4xl">
          Levels 2 and 3 are the standard NoPo platform. Level 4 adds full white-label branding. Level 5 is for firms
          that need a private deployment.
        </p>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-2">
          <div className="rounded-2xl border border-[#4EA1FF]/40 bg-gradient-to-br from-[#0A1A2F] via-[#0D2336] to-[#1A2B1A] p-5 shadow-[0_0_35px_rgba(78,161,255,0.12)]">
            ...
            <p className="mt-2 text-base text-white/70">
              Best if you want a refreshed website and a basic intake form. No automation.
            </p>
          ...
          <div className="rounded-2xl border border-[#4EA1FF]/40 bg-gradient-to-br from-[#0A1A2F] via-[#0D2336] to-[#1A2B1A] p-5 shadow-[0_0_35px_rgba(78,161,255,0.12)]">
            ...
            <p className="mt-2 text-base text-white/70">
              The NoPo platform as-is. Standard onboarding. Standard pricing.
            </p>
            <div className="mt-4 flex flex-wrap gap-2 text-base font-bold text-white">
          ...
          <div className="rounded-2xl border border-[#4EA1FF]/40 bg-gradient-to-br from-[#0A1A2F] via-[#0D2336] to-[#1A2B1A] p-5 text-white shadow-[0_0_35px_rgba(78,161,255,0.15)]">
            ...
            <p className="mt-2 text-base text-white">
              For firms who want platform access plus partner economics and referral upside.
            </p>
            ...
            <div className="mt-5 grid gap-4 lg:grid-cols-2">
              ...
              <div className="rounded-2xl border border-white/15 bg-[#0A1A2F] p-4">
                ...
                <p className="mt-3 text-sm text-white">AI intake included. Voice AI is optional.</p>
              </div>
            </div>
            ...
            <ul className="mt-2 space-y-2 text-base text-white list-disc list-inside marker:text-[#C6FF4D]">
              ...
              <li className="text-white/90">Referral revenue is paid separately. Monthly and per-ticket fees still apply</li>
            </ul>
          </div>
          ...
          <div className="rounded-2xl border border-[#4EA1FF]/40 bg-gradient-to-br from-[#0A1A2F] via-[#0D2336] to-[#1A2B1A] p-5 shadow-[0_0_35px_rgba(78,161,255,0.12)]">
            ...
            <p className="mt-2 text-base text-white/70">
              The NoPo platform with your branding, domain, and client-facing experience. Not a private instance.
            </p>
            <div className="mt-4 flex flex-wrap gap-2 text-base font-bold text-white">
            ...
            <ul className="mt-2 space-y-2 text-base text-white/70">
              ...
              <li>Priority support</li>
              <li className="text-white/90">Uses the standard NoPo platform. Level 5 is for private deployments</li>
            </ul>
          </div>
            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
              <div className="lg:max-w-2xl">
                ...
                <p className="mt-3 text-base text-white/70">
                  For firms that need a private deployment and deeper build work. NoPo retains all IP.
                </p>
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-[#4EA1FF]/50 bg-gradient-to-br from-[#0A1A2F] via-[#0A1A2F] to-[#10253D] p-5">
            ...
            <p className="mt-2 text-base text-white/70">
              If you want a protected territory, exclusivity is priced separately.
            </p>
            <div className="mt-4 flex flex-wrap gap-2 text-base font-bold text-white">
        ...
        <div className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <p className="mt-3 text-base text-white/80">Pick a simple upgrade, full SaaS, flagship partnership, or white-label buildout.</p>
        </div>
      </div>
    </section>
    ...
    <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
      <div className="rounded-2xl border border-white/10 bg-white/5 p-6 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="mt-2 text-white/70 text-base max-w-xl">
            We will tailor onboarding, training, and launch support to your firm size and region. Flagship partners get
            co-marketing support to help us both win the market.
          </p>
        </div>
      ...
      <p className="mt-4 text-sm text-white/40">
        Pricing is a guide. Monthly and per-ticket usage fees apply. Referral revenue is paid separately.
      </p>
    </section>
  </main>
);
